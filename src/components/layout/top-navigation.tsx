  ...
  return (
    <header className="sticky top-0 z-40 border-b border-paper-line bg-paper/96 backdrop-blur-md">
      <div className="mx-auto flex min-h-16 w-full max-w-[1240px] items-center justify-between gap-3 px-5 sm:px-8 lg:px-10">
        <div className="flex min-w-0 items-center gap-2"><Link className="shrink-0 font-display text-xl font-semibold tracking-[-0.045em] text-ink" href="/">{t("brand")}<span className="text-brick">.</span></Link><span className="shrink-0 whitespace-nowrap rounded-[4px] border border-brick bg-brick-tint px-1.5 py-1 text-[0.5rem] font-extrabold text-brick sm:px-2 sm:text-[0.65rem]">{t("independentPrototype")}</span></div>
        <DesktopNavigation />
