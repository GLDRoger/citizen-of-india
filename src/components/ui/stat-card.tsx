...
export function StatCard({ href, icon: Icon, title, value, detail, tone = "action" }: StatCardProps) {
  return (
    <Link className="group grid min-h-48 content-between gap-8 rounded-[20px] border border-line bg-surface p-5 transition-colors hover:border-action/35" href={href}>
      <div className="flex items-start justify-between gap-4">
        ...
        <ArrowUpRight aria-hidden className="size-4 text-ink-faint transition-colors group-hover:text-action" />
      </div>
