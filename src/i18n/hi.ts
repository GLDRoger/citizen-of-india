...
export const hi: Record<MessageKey, string> = {
  ...
  aboutEyebrow: "पूरा विचार",
  aboutTitle: "बेहतर इंटरफ़ेस",
  aboutTitleAccent: "काफ़ी नहीं है।",
  aboutBody: "क्या हो अगर सार्वजनिक सेवाएँ पहली कोशिश में काम करें? Citizen यहीं से शुरू होता है, फिर कठिन सवाल पूछता है: इसे संभव बनाने के लिए इंटरफ़ेस के नीचे क्या जुड़ा होना चाहिए?",
  ...
  graphMapBody: "यह अर्जुन का बीज रिकॉर्ड ग्राफ के रूप में है। पहचान बीच में है; परिवार, काम, संपत्ति, दस्तावेज़ और सरकारी काम उसके चारों ओर जुड़े रहते हैं।",
  ...
  graphMapIdentityBody: "पता और सात दस्तावेज़ वे तथ्य तय करते हैं जिन्हें अगली सेवाएँ फिर इस्तेमाल कर सकती हैं।",
  ...
  graphMapServiceBody: "लाभ, आवेदन, देनदारी और सूचनाएँ नागरिक की कहानी फिर शुरू किए बिना जुड़ती हैं।",
  graphMapResultTitle: "हर नतीजा ग्राफ में लौटता है।",
  graphMapResultBody: "भुगतान देय राशि हटाता है, रसीद बनाता है और उसी इतिहास में जुड़ता है जिसे होम पढ़ता है।",
  graphMapSource: "बीज · {nodes} नोड समूह · {connections} कड़ियाँ",
  ...
  graphVisualBody: "यह Citizen Graph काम करते हुए है। जुड़ा प्रमाण एक बार आता है, सही सेवा उस पर काम करती है और हर प्रभावित दृश्य को नतीजा मिलता है।",
  ...
  boundaryKicker: "इंटरफ़ेस डिज़ाइन की सीमा",
  ...
  boundaryBody: "अगर वजह अधिकारी की कतार, नीति, काम निपटाने की क्षमता या विभाग का डेटाबेस है, तो नया डिज़ाइन उसे हल करने का दावा नहीं कर सकता। हमने तय किया कि इस सीमा के भीतर क्या बदला जा सकता है।",
  ...
  homeGraphTitle: "यह आपके ग्राफ से बना है।",
  ...
  landingHeroBody: "Citizen पहली कोशिश के लिए बना है। सत्यापित प्रमाण पहले से जुड़ा मिलता है, सही सेवा पूरे संदर्भ के साथ खुलती है और नतीजा एक नागरिक रिकॉर्ड में लौटता है। इंटरफ़ेस इसकी ऊपरी परत है।",
  landingBeyondKicker: "Varun Mayya के Build What Moves India हैकाथॉन के लिए बनाया गया।",
  landingBeyondTitle: "हम स्पष्ट सुधारों से आगे गए।",
  landingBeyondBody: "सरल स्क्रीन एक कदम आसान बनाती है। बातचीत से सही सेवा मिलती है। डैशबोर्ड मौजूदा काम समेटता है। Citizen उस मूल समस्या पर काम करता है जिसके कारण हर सेवा फिर से शून्य से शुरू होती है।",
  landingSurfaceOneTitle: "सरल इंटरफ़ेस",
  landingSurfaceOneBody: "एक स्क्रीन के भीतर रुकावट घटाता है",
  landingSurfaceTwoTitle: "बातचीत से शुरुआत",
  landingSurfaceTwoBody: "सही सेवा खोजने में मदद करती है",
  landingSurfaceThreeTitle: "डैशबोर्ड",
  landingSurfaceThreeBody: "पहले से मौजूद काम का सार दिखाता है",
  landingSystemKicker: "व्यवस्था का आधार",
  landingSystemTitle: "Citizen Graph",
  landingSystemBody: "प्रमाण, स्थिति, अनुमति और नतीजे सेवाओं के बीच जुड़े रहते हैं। नागरिक अगली सेवा में गायब नहीं होता।",
  landingHackathonLink: "Build What Moves India हैकाथॉन देखें",
  landingProjectTitle: "अब इस मॉडल को काम करते देखें।",
  landingProjectBody: "ये अलग-अलग डेमो पेज नहीं हैं। हर यात्रा उसी ग्राफ को पढ़ती है, बदलती है और नतीजा Citizen के बाकी हिस्सों में लौटाती है।",
  landingCurrentOne: "गायब EPFO अंशदान शिकायत और होम पर जमा काम बनता है।",
  ...
  landingCurrentFour: "सहमति साझा काम के साथ रहती है और पारिवारिक पहुँच वापस ली जा सकती है।",
