...
export const hi: Record<MessageKey, string> = {
  ...
  landingOriginTitle: "इस हैकाथॉन से पहले मुझे UMANG के बारे में पता नहीं था।",
  landingOriginBodyOne:
    "सरकार बहुत कुछ करती है और हर चीज़ अपने नाम से आती है: एक योजना, एक पोर्टल, एक ऐप, एक समय-सीमा। नाम इतनी तेज़ी से बढ़ते हैं कि कोई उन्हें याद नहीं रख पाता। संदेश आप तक पहुँचते-पहुँचते अक्सर बदल जाता है या उसका अर्थ खो जाता है।",
  landingOriginBodyTwo:
    "UMANG सैकड़ों सेवाएँ एक दरवाज़े के पीछे लाता है। फिर भी वह चाहता है कि आप जानते हुए आएँ कि आपको क्या चाहिए: योजना पहचानें, विभाग ढूँढें, तय करें कि वह आपके काम की है या नहीं। ज़्यादातर लोग इतनी दूर पहुँचते ही नहीं।",
  landingOriginDefinition:
    "Citizen हमारा जवाब है: एक ही पाठक के लिए गज़ट। आपके नाम पर हो रही हर चीज़: भुगतान, सूचनाएँ, आवेदन, लाभ। सब एक जगह, साथ में सुझाव कि और क्या आपके काम का हो सकता है।",
  ...
  startBody:
    "पूरा डेमो अर्जुन में है। प्रिया सहमति और सुनीता साझा पहुँच दिखाती हैं।",
  nudgesTitle: "आपके पूछने से पहले",
  nudgeBenefitTitle: "आप {benefit} के पात्र हैं",
  ...
  healthObligations: "खुले दायित्व",
  healthPayable: "आपको देना है",
  healthReceivable: "आपको मिलना है",
  healthExpiring: "जल्द समाप्त होने वाले दस्तावेज़",
  healthRecordIssues: "रिकॉर्ड विवाद",
  healthUnread: "बिना पढ़ी सूचनाएँ",
  healthUnclaimedTitleOne: "आज आपके लिए 1 योजना उपलब्ध है",
  healthUnclaimedTitleMany: "आज आपके लिए {count} योजनाएँ उपलब्ध हैं",
  rippleEyebrow: "एक बदलाव, जुड़े अगले कदम",
  rippleTitle: "आपका रिकॉर्ड अगले फैसलों के लिए तैयार है",
  rippleCertificateTitle: "प्रमाणपत्र दोनों के पास सुरक्षित",
  rippleCertificateBody: "विवाह प्रमाणपत्र अर्जुन और प्रिया दोनों के दस्तावेज़ों में है।",
  rippleNomineeTitle: "प्रिया को EPF नॉमिनी के रूप में प्रस्तावित करें",
  rippleNomineeBody: "अर्जुन प्रिया को अपना EPF नॉमिनी बनाने का प्रस्ताव भेज सकते हैं। EPFO की पुष्टि सिम्युलेटेड रहेगी।",
  rippleNomineeDoneBody: "प्रिया अब प्रस्तावित EPF नॉमिनी हैं। EPFO की पुष्टि सिम्युलेटेड है।",
  rippleNomineeAction: "नॉमिनी का प्रस्ताव भेजें",
  rippleNomineeOwnerOnly: "यह बदलाव अर्जुन को अपनी प्रोफ़ाइल से मंज़ूर करना होगा।",
  rippleEligibilityTitle: "योजना पात्रता जाँचें",
  rippleEligibilityBody: "हर प्रोफ़ाइल से उपलब्ध योजनाएँ देखें। कोई बदलाव अपने आप लागू नहीं होगा।",
  rippleEligibilityAction: "लाभ जाँचें",
  eventEpfNomineeAdded: "प्रिया EPF नॉमिनी के रूप में प्रस्तावित",
  eventSeedMarriage: "{a} और {b} का विवाह हुआ",
  eventSeedHouse: "{name} ने जे.पी. नगर का घर पंजीकृत किया",
  eventSeedNominee: "{name} EPF नॉमिनी बनीं",
  eventSeedAadhaar: "{name} का आधार जारी हुआ",
  eventSeedPan: "{name} का PAN जारी हुआ",
  eventSeedDl: "{name} का ड्राइविंग लाइसेंस जारी हुआ",
  eventSeedPassport: "{name} का पासपोर्ट जारी हुआ",
  eventSeedJob: "{name} {employer} से जुड़े",
  eventSeedVehicle: "{name} ने {vehicle} पंजीकृत किया",
  eventSeedRetired: "{name} {employer} से सेवानिवृत्त हुए",
  eventSeedBusiness: "{name} ने {business} पंजीकृत किया",
