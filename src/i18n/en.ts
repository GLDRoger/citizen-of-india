export const en = {
  ...
  aboutEyebrow: "The complete idea",
  aboutTitle: "A better interface",
  aboutTitleAccent: "is not enough.",
  aboutBody: "What if public services worked on the first attempt? Citizen starts there, then asks the harder question: what must be connected underneath the interface for that to be possible?",
  ...
  graphMapBody: "This is Arjun’s seeded record as a graph. Identity sits at the centre; family, work, assets, documents and government dealings remain connected around it.",
  ...
  graphMapIdentityBody: "Address and seven documents establish the facts that later services can reuse.",
  ...
  graphMapServiceBody: "Benefits, applications, obligations and notices connect without restarting the citizen’s story.",
  graphMapResultTitle: "Every result returns to the graph.",
  graphMapResultBody: "A payment removes a due amount, creates a receipt and joins the same history that Home reads.",
  graphMapSource: "Seed · {nodes} node groups · {connections} connections",
  graphMapScrollCue: "Scroll to assemble the graph",
  graphMapCompleteCue: "Graph assembled",
  graphVisualTitle: "Choose a problem. Watch the graph respond.",
  graphVisualBody: "This is the Citizen Graph in motion: connected evidence enters once, the right service acts on it, and every affected view receives the result.",
  ...
  boundaryKicker: "The limit of interface design",
  ...
  boundaryBody: "If the cause is a human queue, policy, processing capacity or a department database, a redesign cannot pretend to solve it. We drew that boundary before deciding what to build.",
  ...
  homeGraphTitle: "It was assembled from your graph.",
  ...
  landingHeroBody: "Citizen is designed for the first attempt: verified evidence already connected, the right service opened with context, and the result returned to one citizen record. The interface is only the surface.",
  landingBeyondKicker: "Built for the Build What Moves India hackathon by Varun Mayya.",
  landingBeyondTitle: "We went past the obvious fixes.",
  landingBeyondBody: "Cleaner screens, conversational entry and dashboards each help at the surface. None of them fixes the organising problem: every service still starts from zero.",
  landingSurfaceOneTitle: "Simpler interface",
  landingSurfaceOneBody: "Reduces friction inside one screen",
  landingSurfaceTwoTitle: "Conversational entry",
  landingSurfaceTwoBody: "Helps someone find the right service",
  landingSurfaceThreeTitle: "Dashboard",
  landingSurfaceThreeBody: "Summarises tasks that already exist",
  landingSystemKicker: "The organising model",
  landingSystemTitle: "Citizen Graph",
  landingSystemBody: "Connects evidence, state, permissions and consequences across services, so the citizen does not disappear between them.",
  landingHackathonLink: "Visit the Build What Moves India hackathon",
  landingProjectTitle: "Now watch the model prove itself.",
  landingProjectBody: "These are not disconnected demo pages. Each journey reads the same graph, changes it, and returns the result to the rest of Citizen.",
  landingCurrentOne: "A missing EPFO contribution becomes a grievance and a submitted Home task.",
  ...
  landingCurrentFour: "Consent follows shared work, and family access can be revoked.",
