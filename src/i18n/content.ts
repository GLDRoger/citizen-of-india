...
const hi: LocalizedContent = {
  ...
  ruleExplanations: {
    "Court referral if unpaid past due date.": "समय-सीमा के बाद भुगतान न होने पर मामला अदालत को भेजा जा सकता है।",
...
const kn: LocalizedContent = {
  ...
  ruleExplanations: {
    "Court referral if unpaid past due date.": "ಕೊನೆಯ ದಿನಾಂಕದೊಳಗೆ ಪಾವತಿಸದಿದ್ದರೆ ಪ್ರಕರಣ ನ್ಯಾಯಾಲಯಕ್ಕೆ ಹೋಗಬಹುದು.",
