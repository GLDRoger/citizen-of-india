...
export function ServiceUnavailable() {
  return (
    <Page className="grid min-h-[75vh] place-content-center justify-items-start gap-5">
      <span className="grid size-14 place-items-center rounded-[4px] bg-brick-tint text-brick"><Compass aria-hidden className="size-7" /></span>
      ...
      <p className="max-w-xl text-sm leading-6 text-ink-mute">Citizen currently supports death and marriage journeys, obligations, business-loan decisions, scam checks, and starting a business. Choose one of these to continue.</p>
