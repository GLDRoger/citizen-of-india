...
export function ServiceUnavailable() {
  const { t } = useI18n();
  return (
    <Page className="relative isolate grid min-h-[75vh] place-content-center justify-items-start gap-5 overflow-hidden">
      <Backdrop name="india-gate" variant="compact" />
