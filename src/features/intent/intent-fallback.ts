...
const plans: Record<IntentResponse["language"], Record<ConnectedWorkflow, Plan>> = {
  en: {
    ...
    obligations: { title: "Your deadlines and money", reply: "I found payments, filings, refunds, and document deadlines connected to your records.", steps: ["Review what is due", "Open the right payment or filing", "Track money coming to you"] },
  ...
  hi: {
    ...
    obligations: { title: "आपकी समय-सीमाएँ और पैसे", reply: "आपके रिकॉर्ड से जुड़े भुगतान, फ़ाइलिंग, रिफ़ंड और दस्तावेज़ की समय-सीमाएँ मिल गई हैं।", steps: ["बाकी काम देखें", "सही भुगतान या फ़ाइलिंग खोलें", "आने वाले पैसे पर नज़र रखें"] },
  ...
  hinglish: {
    ...
    obligations: { title: "Aapki deadlines aur paise", reply: "Aapke records se linked payments, filings, refunds aur document deadlines mil gayi hain.", steps: ["Pending kaam dekhein", "Sahi payment ya filing kholein", "Aane wale paise track karein"] },
  ...
  kn: {
    ...
    obligations: { title: "ನಿಮ್ಮ ಗಡುವುಗಳು ಮತ್ತು ಹಣ", reply: "ನಿಮ್ಮ ದಾಖಲೆಗಳಿಗೆ ಸಂಪರ್ಕಿಸಿದ ಪಾವತಿ, ಸಲ್ಲಿಕೆ, ಮರುಪಾವತಿ ಮತ್ತು ದಾಖಲೆ ಗಡುವುಗಳನ್ನು ಕಂಡುಕೊಂಡಿದ್ದೇನೆ.", steps: ["ಬಾಕಿ ಕೆಲಸ ಪರಿಶೀಲಿಸಿ", "ಸರಿಯಾದ ಪಾವತಿ ಅಥವಾ ಸಲ್ಲಿಕೆ ತೆರೆಯಿರಿ", "ನಿಮಗೆ ಬರಬೇಕಾದ ಹಣ ಗಮನಿಸಿ"] },
